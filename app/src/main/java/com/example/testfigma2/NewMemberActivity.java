...
public class NewMemberActivity extends AppCompatActivity {
    ...
    String email_str;
    public NewMemberActivity() throws IllegalAccessException, InstantiationException {
    }
    ...
    public void registration_post(View v){
        ...
        EditText status = findViewById(R.id.edit_status);
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String jsonInputString = getJSON(login.getText().toString(), password.getText().toString(), name.getText().toString(), status.getText().toString(), phone.getText().toString(), male.getText().toString(), date.getText().toString(), email.getText().toString());
